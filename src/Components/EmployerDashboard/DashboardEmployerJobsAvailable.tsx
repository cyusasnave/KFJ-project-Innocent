        ...
        <div className="w-full-h-full flex flex-col md:flex-col lg:flex-row gap-1 md:gap-5">
          <div className="w-full md:w-full lg:w-[60%]">
            <div className="w-full h-max">
              ...
              <div className="w-full h-max flex justify-end items-center p-4">
                <Link to={"/dashboard/employer/list/form"}>
                  <button className="border px-10 py-2 bg-slate-800/70 text-white rounded-lg hover:bg-slate-800/45">
                    Add Job
                  </button>
                </Link>
              </div>
            ...
            <div className="w-full h-max shadow-inner mt-2">
              ...
              <ul className="w-full flex flex-col gap-2 text-sm p-5 border">
                ...
                <li className="w-full">
                  <label className="w-full flex justify-between">
                    <div className="flex gap-2 font-light">
                      <input type="radio" name="radio-1" />1 Year
                    </div>
                  </label>
                </li>
                <li className="w-full">
                  <label className="w-full flex justify-between">
                    <div className="flex gap-2 font-light">
                      <input type="radio" name="radio-1" />3 Year
                    </div>
                  </label>
                </li>
                <li className="w-full">
                  <label className="w-full flex justify-between">
                    <div className="flex gap-2 font-light">
                      <input type="radio" name="radio-1" />5 Year
                    </div>
                  </label>
                </li>
                <li className="w-full">
                  <label className="w-full flex justify-between">
                    <div className="flex gap-2 font-light">
                      <input type="radio" name="radio-1" />7 Year
                    </div>
                  </label>
                </li>
              </ul>

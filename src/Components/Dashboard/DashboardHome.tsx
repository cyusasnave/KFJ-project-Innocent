  ...
  return (
    <div className="flex">
      ...
      <div className="w-full h-max">
        ...
        <div className={`flex items-center gap-10 w-full h-max pt-10 m-auto ${enableBurgerMenu() ? "mt-[80px]" : " "}`}>
        ...
        <div className="w-full my-10">
          ...
          <div className={`w-full h-max text-2xl md:text-4xl font-bold text-center mb-4`}>
            Welcome to K&JF
          </div>
          ...
          <div className="flex justify-center items-center w-full h-max text-2xl ">
            <div className="text-center mt-20 pt-10 border-t-2 border-indigo-400 w-1/2 md:w-1/3 text-base md:text-regular">
              Get Started
            </div>
          </div>
          ...
          <div className="w-full h-max mt-5">
            <div className=" w-[90%] md:w-[80%] m-auto">
              ...
              <div className={`relative mt-5 border-l ${enableBurgerMenu() ? "ml-2 pl-2" : "ml-5 pl-5"}`}>
                  ...
                  {selectedJob.length > 0 ? (
                    selectedJob.map((job, index) => (
                      ...
                      >
                        ...
                        <button className={`bg-red-500/20 py-1 ${enableBurgerMenu() ? "px-2 h-[40px]" : "px-2 h-[40px]"} rounded hover:bg-red-500/30`}>
